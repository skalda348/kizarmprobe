...
// Zde v main, mělo by být asi někde jinde - nelze však dát do hlavičky (jediná instance)
...
// Změněno z define na const (možná delší kód, ale čitší např. pro IDE)

extern LPC_I2C_Type            * const LPC_I2C;
extern LPC_WWDT_Type           * const LPC_WWDT;
extern LPC_USART_Type          * const LPC_USART;
extern LPC_CTxxB0_Type         * const LPC_CT16B0;
extern LPC_CTxxB1_Type         * const LPC_CT16B1;
extern LPC_CTxxB0_Type         * const LPC_CT32B0;
extern LPC_CTxxB1_Type         * const LPC_CT32B1;
extern LPC_ADC_Type            * const LPC_ADC;
extern LPC_PMU_Type            * const LPC_PMU;
extern LPC_FLASHCTRL_Type      * const LPC_FLASHCTRL;
extern LPC_SSPx_Type           * const LPC_SSP0;
extern LPC_SSPx_Type           * const LPC_SSP1;
extern LPC_IOCON_Type          * const LPC_IOCON;
extern LPC_SYSCON_Type         * const LPC_SYSCON;
extern LPC_GPIO_PIN_INT_Type   * const LPC_GPIO_PIN_INT;
extern LPC_GPIO_GROUP_INTx_Type* const LPC_GPIO_GROUP_INT0;
extern LPC_GPIO_GROUP_INTx_Type* const LPC_GPIO_GROUP_INT1;
extern LPC_USB_Type            * const LPC_USB;
extern LPC_GPIO_Type           * const LPC_GPIO;
