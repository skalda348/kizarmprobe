...
} __packed CDC_HEADER_DESCRIPTOR;
...
} __packed CDC_CALL_MANAGEMENT_DESCRIPTOR;
...
} __packed CDC_ABSTRACT_CONTROL_MANAGEMENT_DESCRIPTOR;
...
} __packed CDC_UNION_1SLAVE_DESCRIPTOR;
