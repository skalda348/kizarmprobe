...
//#define WTOTALLENGHT WBVAL(0x68) 
...
uint32_t iA0LineCode  (CDC_LINE_CODING* line_coding) ALIAS (SetLineCodeDefaultHandler);
uint32_t iA0LineState (uint16_t state)               ALIAS (SetCtrlLineStateDefaultHandler);

uint32_t iA1LineCode  (CDC_LINE_CODING* line_coding) ALIAS (SetLineCodeDefaultHandler);
uint32_t iA1LineState (uint16_t state)               ALIAS (SetCtrlLineStateDefaultHandler);
...
uint32_t SetLineCodeDefaultHandler      (CDC_LINE_CODING* line_coding) {
  return 1;
}
uint32_t SetCtrlLineStateDefaultHandler (uint16_t state) {
  return 1;
}

const uint8_t * pConfigDescriptor = (const uint8_t*) &CdcConfig;
